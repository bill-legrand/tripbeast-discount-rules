...
test.describe('Low Rate Discount - Data-Driven Tests', () => {
  ...
  test('Should apply 2% discount to all rates under $100 within date range', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-all-rates-under-100.png',
      fullPage: true 
    });
  });
  ...
  test('Should NOT apply discount to rates at or above $100', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-rates-above-100.png',
      fullPage: true 
    });
  });
  ...
  test('Should apply discount consistently across all dates within range', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-all-dates-within-range.png',
      fullPage: true 
    });
  });
  ...
  test('Should NOT apply discount outside the date range', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-dates-outside-range.png',
      fullPage: true 
    });
  });
  ...
  test('Should apply discount correctly for multi-night stays', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-multi-night-stays.png',
      fullPage: true 
    });
  });
  ...
  test('Should handle boundary cases correctly', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-boundary-cases.png',
      fullPage: true 
    });
  });
});
...
test.describe('Low Rate Discount - Matrix Testing', () => {
  ...
  test('Matrix: Rate threshold boundaries ($99, $99.99, $100, $100.01)', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-matrix-rate-boundaries.png',
      fullPage: true 
    });
  });
  ...
  test('Matrix: Date range boundaries (March 31, April 1, April 15, April 16)', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-matrix-date-boundaries.png',
      fullPage: true 
    });
  });
  ...
  test('Matrix: Combined rate and date scenarios', async ({ cugPage }) => {
    ...
    await cugPage.screenshot({ 
      path: 'test-results/hotel/screenshots/low-rate-discount-matrix-combined.png',
      fullPage: true 
    });
  });
});
