...
test.describe('Ancillary 10% Discount Test (Feb 1-2, 2026)', () => {
  ...
  test('with discount-rule JWT: should apply 10% discount to Las Vegas hotels for Feb 1-2, 2026', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/hotel/ancillary-10percent-discount.png', fullPage: true });
    console.log('📸 Screenshot saved to test-results/hotel/ancillary-10percent-discount.png');
  ...
  test('discount on subtotal: navigate to price breakdown and verify', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/hotel/ancillary-discount-on-subtotal.png', fullPage: true });
    console.log('📸 Screenshot: test-results/hotel/ancillary-discount-on-subtotal.png');
  });
});
