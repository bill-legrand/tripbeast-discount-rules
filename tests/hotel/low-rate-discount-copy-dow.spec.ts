...
test.describe('Low Rate Discount - Copy DOW Method', () => {
  ...
  test('Should load hotel and find prices (April 5, 2026)', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: `test-results/hotel/screenshots/low-rate-discount-copy-dow-april-5.png`,
      fullPage: true 
    });
  ...
  test('Should check discount BEFORE Low Rate period (March 31, 2026)', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: `test-results/hotel/screenshots/low-rate-discount-copy-dow-march-31.png`,
      fullPage: true 
    });
  ...
  test('Should check discount AFTER Low Rate period (April 16, 2026)', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: `test-results/hotel/screenshots/low-rate-discount-copy-dow-april-16.png`,
      fullPage: true 
    });
