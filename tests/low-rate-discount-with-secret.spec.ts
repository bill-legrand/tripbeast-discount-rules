...
test.describe('Low Rate Discount - Using JWT Secret', () => {
  ...
  test('Should test Low Rate Discount with secret key (April 5, 2026)', async ({ page }) => {
    ...
    await page.screenshot({ 
      path: `screenshots/low-rate-secret-method1-april-5.png`,
      fullPage: true 
    });
    ...
    await page.screenshot({ 
      path: `screenshots/low-rate-secret-method2-april-5.png`,
      fullPage: true 
    });
    ...
    await page.screenshot({ 
      path: `screenshots/low-rate-secret-method3-april-5.png`,
      fullPage: true 
    });
