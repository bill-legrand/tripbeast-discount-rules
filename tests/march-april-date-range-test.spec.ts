...
test.describe('March-April Date Range Testing', () => {
  ...
  test('Should test Longhorn Casino across March and April date ranges', async ({ page }) => {
    ...
    // Save results
    const fs = require('fs');
    fs.writeFileSync('screenshots/march-april-discount-analysis.json', JSON.stringify({
    ...
    console.log('💾 Detailed results saved to: screenshots/march-april-discount-analysis.json\n');
  });
});
