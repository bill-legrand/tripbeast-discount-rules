...
test.describe('Low Rate Discount - Real Hotel Tests', () => {
  ...
  test('Should check Low Rate Discount on April 5, 2026 (within range)', async ({ page }) => {
    ...
    if (!pricesFound) {
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-no-prices-found.png`,
        fullPage: true 
      });
    }
    ...
    try {
      ...
      // Take screenshot
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-5-actual.png`,
        fullPage: true 
      });
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-error.png`,
        fullPage: true 
      });
      throw error;
    }
  ...
  test('Should NOT apply Low Rate Discount before date range (March 31, 2026)', async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-march-31-before-range.png`,
        fullPage: true 
      });
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-march-31-error.png`,
        fullPage: true 
      });
    }
  });
  ...
  test('Should NOT apply Low Rate Discount after date range (April 16, 2026)', async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-16-after-range.png`,
        fullPage: true 
      });
      ...
      console.error('Error:', error);
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-16-error.png`,
        fullPage: true 
      });
    }
  });
  ...
  test('Should apply Low Rate Discount on first day (April 1, 2026)', async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-1-first-day.png`,
        fullPage: true 
      });
      ...
      console.error('Error:', error);
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-1-error.png`,
        fullPage: true 
      });
    }
  });
  ...
  test('Should apply Low Rate Discount on last day (April 15, 2026)', async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-15-last-day.png`,
        fullPage: true 
      });
      ...
      console.error('Error:', error);
      await page.screenshot({ 
        path: `screenshots/low-rate-discount-april-15-error.png`,
        fullPage: true 
      });
    }
  });
