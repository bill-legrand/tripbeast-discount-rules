...
test.describe('Low Rate Discount - Comprehensive April Testing', () => {
  ...
  test('April 1-2, 2026 (1 night) - Start of discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-01-single.png`, fullPage: true });
  });
  ...
  test('April 5-6, 2026 (1 night) - Middle of discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-05-single.png`, fullPage: true });
  });
  ...
  test('April 10-11, 2026 (1 night) - Middle of discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-10-single.png`, fullPage: true });
  });
  ...
  test('April 15-16, 2026 (1 night) - End of discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-15-single.png`, fullPage: true });
  });
  ...
  test('April 5-8, 2026 (3 nights) - Multi-night stay', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-05-08-multi.png`, fullPage: true });
  });
  ...
  test('April 1-15, 2026 (14 nights) - Full discount period', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-01-15-full.png`, fullPage: true });
  });
  ...
  test('March 31 - April 1, 2026 (1 night) - BEFORE discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-march-31-before.png`, fullPage: true });
  });
  ...
  test('April 16-17, 2026 (1 night) - AFTER discount range', async ({ page }) => {
    ...
    await page.screenshot({ path: `screenshots/low-rate-april-16-after.png`, fullPage: true });
  });
});
